export const PERSON_CONTEXTS = {
  ...
  GET_LATEST_PERSON: 'Failed to get latest person',
  GET_ALL_PERSONS: 'Failed to get all persons',
  UPDATE_PERSON: 'Failed to update person',
  GET_MY_PERSON_PROFILE: 'Failed to get my person profile',
  STORE_PRIVATE_PERSON_DATA: 'Failed to store private person data',
  GET_AGENT_PRIVATE_DATA: 'Failed to get agent private data',
  ASSIGN_PERSON_ROLE: 'Failed to assign person role',
  GET_PERSON_ROLES: 'Failed to get person roles',
  GET_PERSON_CAPABILITY_LEVEL: 'Failed to get person capability level',
  HAS_PERSON_ROLE_CAPABILITY: 'Failed to check person role capability',
